...
exports.OpenTicketUseCase = void 0;
...
let OpenTicketUseCase = class OpenTicketUseCase {
    ticketRepository;
    ...
    async execute(ticketId, userId) {
        ...
        const transitioned = await this.ticketWorkflowService.transitionToStateName(ticketId, 'EN_PROCESO', userId);
        return { transitioned };
    }
};
exports.OpenTicketUseCase = OpenTicketUseCase;
exports.OpenTicketUseCase = OpenTicketUseCase = __decorate([
...
//# sourceMappingURL=open-ticket.use-case.js.map